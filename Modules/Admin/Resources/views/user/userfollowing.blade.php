...
@section('breadcrumb')
<li>
    <span class="active">User Following</span>
</li>
@stop
    ...
    <div class="portlet-body ">
        <div class="clearfix">
            <div class="table-scrollable" style="border: none;">
                <table class="ui celled table table-bordered" cellspacing="0" width="100%" id="user-follow">
                    <thead>
                        <tr>
                            <th>#</th>
...
<script>
    $(function () {
        ...
        $('#user-follow').DataTable({
            processing: false,
            serverSide: true,
            order: [[2, "desc"]],
            ajax: {
                "url":'{{ Route("admin-user-following-list-datatable") }}',
                "data":{
                    id:user_id
                }
            },
