...
@section('breadcrumb')
<li> <a href="{{ Route('admin-contact') }}">Careers</a></li>
            ...
            <div class="row">
                {{-- <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <p class="form-control-static"> {{ (isset($model->department) && $model->department != null) ? $model->department : "Not Given" }} </p>
                        </div>
                    </div>
                </div> --}}
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            @php
                                $cat=App\Models\TranslationCategory::where('category_id',$model->category_id)->where('lang_code','en')->first();
                            @endphp
                            <p class="form-control-static"> {{$cat->category_name}} </p>
                        </div>
                    </div>
                </div>
                {{-- <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <p class="form-control-static"> {{ (isset($model->website) && $model->website != null) ? $model->website : "Not Given" }} </p>
                        </div>
                    </div>
                </div> --}}
                {{-- <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label col-md-3">describes :</label>
                        <div class="col-md-9">
                            <p class="form-control-static"> {{ (isset($model->describes) && $model->describes != null) ? $model->describes : "Not Given" }} </p>
                        </div>
                    </div>
                </div> --}}
                <div class="col-md-6">
