                            ...
                            <ul class="ui-sortable">
                                ...
                                foreach ($module as $settings) {
                                    ...
                                    switch ($settings->type) {
                                        ...
                                        case 'file':
                                            $html .= "<div class=\"input type-{$settings->type}\">";
                                            $html .="<img alt='' style='width: 200px; height: 150px;' src=".URL::asset('public/uploads/frontend/logo/'.$settings->value)." accept='image/png, image/jpeg'>";
                                            $html .= "<input type=\"file\" class=\"form-control\" id=\"{$settings->slug}\" name=\"settings[{$settings->slug}]\" value=\"{$settings->value}\">";
                                            $html .= $show_slug;
                                            $html .= "</div>";
                                            break;
