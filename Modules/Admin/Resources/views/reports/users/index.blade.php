    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-users font-green-haze" aria-hidden="true"></i>
                ...
                <div class="table-scrollable">
                    <table class="table table-striped table-bordered table-advance table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td> {{ $key + 1 }} </td>
                                <td> {{ (isset($val->name) && $val->name != '') ? ucFirst($val->name) : "Not Given" }} </td>
                                <td>  
                                    @if ($val->status == '0') 
                                ...
                                <td>
                                    <a href="{{ Route('admin-viewuser', ['id' => base64_encode($val->id)]) }}" class="btn btn-outline btn-circle btn-sm blue">
                                        <i class="fa fa-eye"></i> View
                                    </a>
                                    <a href="{{ Route('admin-updateuser', ['id' => base64_encode($val->id)]) }}" class="btn btn-outline btn-circle btn-sm purple">
