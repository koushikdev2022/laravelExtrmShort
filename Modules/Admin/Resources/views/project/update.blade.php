...
<div class="taskBox">
    ...
    <div class="taskBody">
        <div class="form-floating mb-3">
            ...
            <input type="text" class="form-control" name="title" id="floatingInput" value="{{$project->title}}" placeholder="Enter Title">
        ...
        <div class="form-group allim">
            ...
            <div class="input-group">
                ...
                <div class="image_upload_div" style="width: 100%;">
                    <form action="{{ Route('admin-project-photo') }}" method="post" class="dropzone" id="my-dropzone">
                        @csrf
                    </form>
                </div>
            ...
            <div class="col-md-5 col-md-xl-5">
                <div class="form-floatingx resMb-3">
                    ...
                    <select multiple="multiple"
                        class="js-example-placeholder-multiple-availablity  form-control cast-slet" name="avl_date[]"
            ...
            <div class="col-md-7 col-md-xl-7">
                <div class="input-group">
                    <div class="form-floating w-70">
                        <input type="date" class="form-control form-floating-left" value="{{$project->begin_date}}" id="floatingInput" name="begin_date"
                            placeholder="name@example.com">
                        <label for="floatingInput">Beginning</label>
                    </div>
                    <div class="form-floating w-30">
                        <input type="time" class="form-control form-floating-right" value="{{$project->begin_time}}" id="floatingInput" name="begin_time"
                            placeholder="name@example.com">
        ...
        <div class="form-floating input-location input-group mb-3">
            <input id="searchMapInput" placeholder="Street, house No., floor, apartment" name="start_address" value="{{$project->start_address}}" type="text" class="form-control mapControls searchMapInput">
        ...
        <div class="d-flex align-items-center mb-3">
            <div class="flex-fill">
                ...
                <div class="form-floating input-location input-group" id="location_id{{$project_address->id}}">
                    <input id="searchMapInput1" placeholder="Street, house No., floor, apartment" name="final_address[]" value="{{$project_address->final_address}}" type="text" class="form-control mapControls searchMapInput1">
                    <input id="location-snap" placeholder="Enter your address" name="address_line2[]" type="hidden" value="{{$project_address->address_line2}}" class="form-control mapControls location-snap">
                    <input id="lat-span" placeholder="Enter your address" name="final_latitude[]" type="hidden" value="{{$project_address->final_latitude}}"  class="form-control mapControls lat-span">
                    <input id="lon-span" placeholder="Enter your address" name="final_longitude[]" value="{{$project_address->final_longitude}}" type="hidden" class="form-control mapControls lon-span">
                    <label for="code1">Street, house No., floor, apartment </label>
                    <span class="input-group-text inputGroupWhite"><a href="javascript:void(0);" data-tbl="location"   data-href="{{Route('admin-location-delete', [base64_encode($project_address->id)])}}" data-title="Location" onclick="deleteObject(this);" title="Delete"><i class="fa fa-trash" style="color: red"></i></a></span>
                </div><br>
                @endforeach
            </div>
    ...
    $(document).ready(function() {
        ...
        $(add).click(function(e) {
            ...
            if (x < max) { //maximum number of input field allowed
                ...
                html += '<input id="location-snap'+x+'" placeholder="Enter your address" name="address_line2[]" type="hidden" class="form-control mapControls location-snap">';
                html += '<input id="lat-span'+x+'" placeholder="Enter your address" name="final_latitude[]" type="hidden" class="form-control mapControls lat-span">';
                html +='<input id="lon-span'+x+'" placeholder="Enter your address" name="final_longitude[]" type="hidden" class="form-control mapControls lon-span">';
                        ...
                        success: function (data) {
                            if (data.res == 1) {
                                $.each(data.images, function (key, value) {
                                    ...
                                    thisDropzone.options.thumbnail.call(thisDropzone, mockFile, (base_url + '/storage/uploads/frontend/project/') + value.name);
