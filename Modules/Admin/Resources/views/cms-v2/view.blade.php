    ...
    <div class="portlet-body form">
        ...
        <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <video controls class="img-responsive">
                                    <source src="{{ URL::asset('storage/uploads/frontend/cms/videos/' . $model->content_body) }}" type="video/mp4" alt="{{ $model->content_body }}">
                                </video>
                            </div>
                            @else
            ...
            <div class="form-actions text-right">
                <a href="{{ Route('admin-updatecms', ['id' => base64_encode($model->id)]) }}" class="btn green">
