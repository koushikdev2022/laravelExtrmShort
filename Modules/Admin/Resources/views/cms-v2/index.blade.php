                    ...
                    <table class="table table-striped table-bordered table-advance table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                   <a href="{{ Route('admin-viewcms', ['id' => base64_encode($val->id)]) }}" class="btn btn-outline btn-circle btn-sm blue">
                                        <i class="fa fa-eye"></i> View
                                    </a>
                                    <a href="{{ Route('admin-updatecms', ['id' => base64_encode($val->id)]) }}" class="btn btn-outline btn-circle btn-sm purple">
