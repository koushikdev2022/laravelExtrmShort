...
<div class="page-lock">
    <div class="page-logo text-center">
        <a class="brand" href="{{ Route('admin-lockscreen') }}">
            <img src="{{ URL::asset('storage/backend/images/fav-icon.png') }}" width="140" alt="logo" />
        </a>
    </div>
    <div class="page-body">
        @if (isset($admin_model->profile_picture) && !empty($admin_model->profile_picture))
        <img class="page-lock-img" src="{{ URL::asset('storage/uploads/admin/profile_picture/preview/' . $admin_model->profile_picture) }}" onerror="this.src='{{ URL::asset('storage/backend/assets/pages/img/admin-default.jpg') }}'" alt="">
        @else
        <img class="page-lock-img" src="{{ URL::asset('storage/backend/assets/pages/img/admin-default.jpg') }}" alt="">
        @endif
