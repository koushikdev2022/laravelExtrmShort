                            ...
                            <div class="processBody">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <span class="help-block has-error text-danger" id="videoValidationMessage"></span>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control groupInput quality" id="quality_{{$countdown}}" name="quality_amount[]" value="{{ $info->quality_amount }}" aria-label="Amount (to the nearest dollar)">
                                                <div class=" text-danger help-block"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select-commission " id="commission_0{{$countdown}}" name="licence_for[]">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text"><i class="icofont-dollar"></i></span>
                                                <input type="text" class="form-control groupInput licence_amount" id="licence_amount_0{{$countdown}}" name="licence_amount[]" value="{{ $info->licence_amount }}" aria-label="Amount (to the nearest dollar)">
                                                <div class=" text-danger help-block"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="custom-control-input exclusive" id="customRadio" name="is_exclusive" value="1" {{ $data['is_exclusive'] == '1' ? 'checked' : ''}}>
                                                <label class="custom-control-label" for="customRadio">Yes</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="custom-control-input exclusive" id="customRadio2" name="is_exclusive" value="0" {{ $data['is_exclusive'] == '0' ? 'checked' : ''}}>
                                                <label class="custom-control-label" for="customRadio2">No</label>
                                            </div>
                                        </div>
                                        @if($data['is_exclusive'] == '1')
                                        <div  class="form-group" id="exclusiveField">
                                            <label>Exclusive Amount</label>
                                            <input type="text" class="form-control" name="exclusive_amount" value="{{ $data['exclusive_amount'] }}">
                                        </div>
                                        @endif
...
<script>
     ...
     $('.select-commission').on('change', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                $('.licence_amount').html('');
                $(".licence_amount").val(response.percentile);
    ...
    $('.quality').on('keyup',function(){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var licence_id = $('.licence_amount').attr('id');
                $("#"+licence_id).val(licence_Amount);

                var comibination_id = $('.combiningAmount').attr('id');
                $('#'+comibination_id).html('')
                $('#'+comibination_id).append('$'+  total)
                ajaxindicatorstop();
            }
        });
    });
    ...
    $('#addCombination').click(function() {
        ...
        html += '<input type="text" class="form-control groupInput quality" id='+`quality_${i}`+' name="quality_amount[]" aria-label="Amount (to the nearest dollar)">';
        html += '<div class=" text-danger help-block"></div>';
        ...
        html += '<select class="form-control select-commission" name="licence_for[]" id='+`commission_${i}`+'>';
        ...
        html += '<div class="input-group">';
        html += '<span class="input-group-text"><i class="icofont-dollar"></i></span>';
        html += '<input type="text" class="form-control groupInput licence_amount" id='+`licence_amount_${i}`+' name="licence_amount[]" aria-label="Amount (to the nearest dollar)" >';
        html += '<div class=" text-danger help-block"></div>';
        ...
        html += '<h4 class="combiningAmount" id='+`combiningAmount_${i}`+'>$35</h4>';
        html + '</div>';
        html += '</div>';
        html += '</div>';
