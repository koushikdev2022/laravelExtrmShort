                ...
                <div class="justify-content-center">
                    <div class="col-md-12">
                        ...
                        <div class="processCard">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" placeholder="" name="description" rows="8"></textarea>
                                            <span class="help-block has-error text-danger"></span>
                            ...
                            <!-- <input type="hidden" value="" name="draft_1" id="draft_1"> -->
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="category" class="categorySelector" onchange="changeCategory(this)" id="exampleFormControlSelect1">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="ans_checkbox jobTag">
                                                ...
                                                <a class="btnSeeMore" href="javascript:void(0)">See More</a>
                                            </div>
                                            <div class=" text-danger help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control groupInput" name="quality_amount[]" aria-label="Amount (to the nearest dollar)">
                                                <div class=" text-danger help-block"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="licence_for[]" id="exampleFormControlSelect1">
                                                    <option value="1">Internet Only Use</option>
                                                    <option value="2">Other Only Use</option>
                                                </select>
                                                <div class=" text-danger help-block"></div>
                                            </div>
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text"><i class="icofont-dollar"></i></span>
                                                <input type="text" class="form-control groupInput" name="licence_amount[]" aria-label="Amount (to the nearest dollar)">
                                                <div class=" text-danger help-block"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
...
<script>
    ...
    $('#addCombination').click(function() {
        ...
        html += '<option>HD</option>';
        html += '<option>4K</option>';
        html += '</select>';
        ...
        html += '<option>Internet Only Use</option>';
        html += '<option>Other Only Use</option>';
        html += '</select>';
        html += '<div class=" text-danger help-block"></div>';
