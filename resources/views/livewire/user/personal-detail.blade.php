        ...
        <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="avatar-upload">
                                ...
                                <div class="avatar-preview">
                                    @if ($profile_picture)
                                    <div id="imagePreview" style="background-image: url('{{ $profile_picture->temporaryUrl() }}');">
                                    </div>
                                    @else
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" wire:model.defer="profileform.city" class="form-control" placeholder="">
                    @error('profileform.city')
                    <span class="help-block">{{ $message }}</span>
                    @enderror
                </div>
            </div>
            ...
            <div class="col-sm-6" wire:ignore>
                <div class="form-group">
                    ...
                    <select multiple="multiple" class="js-example-placeholder-multiple form-control cast-slet"
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input id="lat-span" placeholder="Enter your address" wire:model.defer="latitude" type="hidden" class="form-control mapControls lat-span" >
                    <input id="lon-span" placeholder="Enter your address" wire:model.defer="longitude" type="hidden" class="form-control mapControls lon-span">
...
{{--
    ...
    $(document).ready(function() {
        ...
        $('.js-example-placeholder-multiple.availablity').on('change', function(e) {
            if ($(e.target).hasClass('availablity')) {
                var data = $('.js-example-placeholder-multiple.availablity').select2().val();
                @this.set('availablity', data);
            }
        });
        ...
        $('.js-example-placeholder-multiple.categories').on('change', function(e) {
            if ($(e.target).hasClass('categories')) {
        ...
        function address(){
            var data = $("#location-snap").val();
            console.log(data);
            @this.set('address_line2', data);
        }
    });
    </script>
