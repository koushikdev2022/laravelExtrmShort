                                ...
                                <div class="filterSection pt-4">
                                    ...
                                    <div class="input-group searchGroup mb-3 igLeftIcon">
                                        ...
                                        <input type="text" class="form-control simpleFormControl ps-0 search_keywords" name="code1"
                                            placeholder="{{__('site.Search by keywords')}} " >
                                    </div>

                                    <div class="form-floatFix form-Flabel mb-3">
                                        <label>{{__('site.Search by keywords')}} </label>
                                    ...
                                    <div class="form-floating mb-3">
                                        <select class="form-select" id="floatingSelect" aria-label="Floating label select example">
                                            <option selected="">Appliance Repair and Installation</option>
                                    ...
                                    <div class="form-floating mb-3">
                                        <select class="form-select" id="floatingSelect" aria-label="Floating label select example">
                                            <option selected="">Refrigerators And Freezers </option>
                                            <option value="1">One</option>
                                            <option value="2">Two</option>
                                            <option value="3">Three</option>
                                        </select>
                                    ...
                                    <div>
                                        <label class="labelMain">Budget</label>
                                    </div>
                    ...
                    <div class="filterSection pt-4">
                        ...
                        <div class="input-group searchGroup mb-3 igLeftIcon">
                            ...
                            <input type="text" class="form-control simpleFormControl ps-0" name="code1"
                                placeholder="{{__('site.Search by keywords')}} " id="search_keywords">
                        </div>

                        <div class="form-floatFix form-Flabel mb-3">
                            <label>{{__('site.City, address, metro station, district...')}} </label>
                            <span><i class="icofont-location-pin"></i></span>
                            <input id="searchMapInput" placeholder="{{__('site.Enter your address')}}" name="address_line1" type="text" class="form-control mapControls">
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select distance_km_search" name="distance_km" id="searh_distance_km">
                                <option value="">{{__('site.Distance')}}</option>
                                <option value="5">+5 {{__('site.KM')}}</option>
                                <option value="10">+10 {{__('site.KM')}}</option>
                                <option value="15">+15 {{__('site.KM')}}</option>
                                <option value="20">+20 {{__('site.KM')}}</option>
                                <option value="30">+30 {{__('site.KM')}}</option>
                                <option value="40">+40 {{__('site.KM')}}</option>
                                <option value="50">+50 {{__('site.KM')}}</option>
                            </select>
                            <label for="floatingSelect">{{__('site.Distance')}}</label>
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select skill_search" id="searh-show-subcategory" name="skill_id" aria-label="Floating label select example">
                                <option value="">{{__('site.Select Subcategory')}}</option>
                            </select>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('body').on('change','.distance_km_search',function(){
            var map_data = $('#searchMapInput').val();
            if(map_data=='')
            {
                notie.alert({
                    type: 'error',
                    text: '<i class="fa fa-check"></i> Please enter address first' ,
                    time: 3
                });
            }
            var type = $(this).data('type');
        ...
        function fetch_search_data(page=1,type=null)
        {
            ...
            if(type==1){
                ...
                var location_snap = $('#location-snap').val();
                var lat_span = $('#lat-span').val();
                var lon_span = $('#lon-span').val();
                var searh_distance_km = $('select.distance_km_search option:selected').val();
            ...
            data: {keywords:keywords,optionvalue:optionvalue,category_id:category_id,page:page,min:min,max:max,type:type,map_data:map_data,sub_category:sub_category,location_snap:location_snap,lat_span:lat_span,lon_span:lon_span,searh_distance_km:searh_distance_km},
