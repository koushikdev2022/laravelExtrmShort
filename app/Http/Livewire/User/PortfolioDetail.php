...
class PortfolioDetail extends Component
{
    ...
    {
        $this->user_detail = auth()->guard('frontend')->user()->details;
    ...
    {
        return view('livewire.user.portfolio-detail');
    }
    ...
    public function store()
    {
        ...
        if (sizeof($this->portfolios) > 0) {
            ...
            $this->dispatchBrowserEvent('livealert', ['type' => 'success', 'message' => 'Your portfolios saved successfully.', 'showtime' => 4]);
        }
    }
